const Targeting = Vue.createApp({
    data() {
        return {
            ...
            StandardEyeIcon: "fas fa-eye", // This is the default eye icon
            CurrentIcon: this.StandardEyeIcon, // leave this
            SuccessColor: "rgb(44, 160, 93)", // This is the color when the target has found the option
            StandardColor: "black", // This is the standard color, change this to the same as the StandardColor if you have changed it
            ...
            for (let [index, itemData] of Object.entries(item.data)) {
                if (itemData !== null) {
                    ...
                    if (this.ChangeTextIconColor) {
                        this.targetLabel.innerHTML +=
                        `<div id="target-option-${index}" style="margin-bottom: 1vh; color: white">
